...
os.makedirs("images/wganmulti_{}".format(timestamp))
...
class WGAN():
    def __init__(self):
        ...
        #self.generator_model = multi_gpu_model(Model(z_gen, valid), gpus=4)
    ...
    def build_generator(self):
        ...
        img = model(noise)
        return multi_gpu_model(Model(noise, img), gpus=4)
    ...
    def build_critic(self):
        ...
        validity = model(img)
        return multi_gpu_model(Model(img, validity), gpus=4)
    ...
    def sample_images(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("images/wganmulti_{}/{}.png".format(timestamp, epoch))
        plt.close()
